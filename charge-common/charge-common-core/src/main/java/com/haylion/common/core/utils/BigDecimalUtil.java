...
public final class BigDecimalUtil {
    ...
    public static boolean isInsideInclusiveRange(final BigDecimal bd, final BigDecimal lowerLimit, final BigDecimal upperLimit) {
        return Objects.nonNull(bd) && Objects.nonNull(lowerLimit) && Objects.nonNull(upperLimit) && bd.compareTo(lowerLimit) >= 0 && bd.compareTo(upperLimit) <= 0;
    }
