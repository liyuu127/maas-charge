...
import static com.haylion.common.core.constant.SecurityConstant.MOBILE_LOGIN_URL;

/**
 * @Classname SmsCodeAuthenticationFilter
 * @Description 1.认证请求的方法必须为POST
 * 2.从request中获取手机号
...
public class SmsCodeAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    SmsCodeAuthenticationFilter() {
        super(new AntPathRequestMatcher(MOBILE_LOGIN_URL, HttpMethod.POST.toString()));
    }
    ...
    private String obtainMobile(HttpServletRequest request) {
        return request.getParameter(SecurityConstant.PHONE_KEY);
    }
}
